%-------------------------------------------------------------------------------
% midiname-reference-guide
%-------------------------------------------------------------------------------
%
% \file        midiname-reference-guide.tex
% \library     Documents
...
%
%     This document provides LaTeX documentation for the midiname library.
%
%-------------------------------------------------------------------------------
...
\title{Midiname Developer Guide 0.1.0}
\author{Chris Ahlstrom \\
...
\begin{figure}[H]
   \centering 
   \includegraphics[scale=0.25]{midiname.png}
   \caption*{Midiname Logo}
\end{figure}
...
\label{sec:introduction}
   ...
   The \textsl{Midiname} library reworks some of the fundamental code
   from the \textsl{Ardour} DAW project (\cite{ardour}).

   Midiname contains the following subdirectories of \texttt{src} and
...
\label{subsec:introduction_conventions}
   ...
   \textsl{Midiname} uses some conventions for naming things in this
   document.
...
\label{sec:summary}
   ...
   Contact: If you have ideas about \textsl{Midiname} or a bug report,
